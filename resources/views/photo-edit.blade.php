...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('css/postimg.css') }}">
...
<body>
    ...
    <div class="main">
        ...
        <form id="uploadForm" method="POST" action="{{ route('photos.update', $photo->id) }}" enctype="multipart/form-data">
        @csrf
        @method('PUT')
            ...
            <div class="input-text">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="description" name="description" value="{{ $photo->title }}">
                </div>
                ...
                <div class="button">
                    <button class="btn btn rounded-pill fw-semibold" type="submit"
                        ...
                        onmouseout="this.style.backgroundColor='#9AB2DB';this.style.color='#ffff';">Update Image</button>
                    ...
                    <button class="btn btn rounded-pill fw-semibold" type="button"
                        ...
                        onmouseout="this.style.backgroundColor='#F9F9F9';this.style.color='#1A1A1A';"><a href="/albums" style="color: #1A1A1A;text-decoration:none;">Cancel</a></button>
                </div>
            </div>
        </form>
    </div>
    ...
    <script>
        ...
        // Untuk menampilkan gambar dari PHP
        @php $photos = Storage::url('images/'.$photo->photo); @endphp
        const imageUrl = "{{ url($photos) }}";
        const imagePreview = document.getElementById("imagePreview");
